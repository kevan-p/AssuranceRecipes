...
function App() {
  ...
  return (
    ...
    <div className="container">
      <a className="navbar-brand js-scroll-trigger" href="#page-top">SDMAY2020-26</a>
      ...
      <div className="collapse navbar-collapse" id="navbarResponsive">
        <ul className="navbar-nav text-uppercase ml-auto">
          <li className="nav-item">
            <a className="nav-link js-scroll-trigger" href="#services">Introduction</a>
          </li>
          <li className="nav-item">
            <a className="nav-link js-scroll-trigger" href="#portfolio">Graphs</a>
          </li>
          <li className="nav-item">
            <a className="nav-link js-scroll-trigger" href="#about">Template</a>
          </li>
          <li className="nav-item">
  ...
  <header className="masthead">
    <div className="container">
      <div className="intro-text">
        ...
        <div className="intro-heading text-uppercase">Assurance Recipes</div>
        <a className="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="#services">Introduction</a>
      </div>
    </div>
  </header>
...
Safety Cases take their design strategy from the aeronautics and software engineering communities (Kelly and Weaver, 2004) where they can also be seen under the title Assurance Arguments using Goal Structuring Notation (GSN). There they are used to ensure the safety of various parts of the aircraft and target certain problem areas in the functions and dangers of the process of flight. Unlike aeronautics, synthetic biologists do not have to worry about engine and wing design or console displays, but they do have to worry about accidental release of bacteria and plasmid conjugation as well as other concerns. As synthetic biology grows to new heights and levels of complexity, the number of safety concerns a single project or application needs to address will also grow. Just as people trust the engineering of an airplane despite the many risks, Safety Cases can help people who use genetically modified organisms feel confident that what they are using is safe.</h3>
  ...
  <section className="page-section" id="about">
    <div className="container">
      <div className="row">
        <div className="col-lg-12 text-center">
          <h2 className="section-heading text-uppercase">Project Timeline</h2>
          <h3 className="section-subheading text-muted">Project Progress</h3>
        </div>
      </div>
      <div className="row">
            ...
            <li>
              ...
              <div className="timeline-panel">
                ...
                <div className="timeline-body">
                  <p className="text-muted">Project started at Hackathon by _ and _</p>
                </div>
              </div>
            </li>
    ...
    <div className="container">
      <div className="row">
        <div className="col-lg-12 text-center">
          ...
          <h3 className="section-subheading text-muted">Senior Design Group 26 - 2020</h3>
        </div>
      </div>
      <div className="row">
      ...
      <div className="row">
        <div className="col-sm-4">
          <div className="team-member">
            <img className="mx-auto rounded-circle" src="img/team/4.jpg" alt=""/>
            <h4>ShiWei Wang</h4>
        ...
        <div className="col-sm-4">
          <div className="team-member">
            <img className="mx-auto rounded-circle" src="img/team/5.jpg" alt=""/>
        ...
        <div className="col-sm-4">
          <div className="team-member">
            <img className="mx-auto rounded-circle" src="img/team/6.jpg" alt=""/>
            <h4>Kevan Patel</h4>
      ...
      <div className="row">
        <div className="col-lg-8 mx-auto text-center">
          <p className="large text-muted">Senior Design Group 26 August 2019 - May 2020</p>
        </div>
      </div>
    </div>
  </section>
    ...
    <div className="container">
      <div className="row">
        <div className="col-lg-12 text-center">
          ...
          <h3 className="section-subheading text-muted">Have any questions? Let us know!</h3>
        </div>
      </div>
      <div className="row">
        <div className="col-lg-12">
